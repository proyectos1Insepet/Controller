...
ALTER TABLE public.botones OWNER TO db_admin;
...
ALTER TABLE public.configuracion OWNER TO db_admin;
...
ALTER TABLE public.configuracion_pk_idconfiguracion_seq OWNER TO db_admin;
...
ALTER TABLE public.configuraciondispensador OWNER TO db_admin;
...
ALTER TABLE public.configuraciondispensador_pk_idconfiguraciondispen_seq OWNER TO db_admin;
...
ALTER TABLE public.consignaciones OWNER TO db_admin;
...
ALTER TABLE public.copiaderecibo OWNER TO db_admin;
...
ALTER TABLE public.copiaderecibo_pk_idcopiarecibo_seq OWNER TO db_admin;
...
ALTER TABLE public.discriminapago OWNER TO db_admin;
...
ALTER TABLE public.estado OWNER TO db_admin;
...
ALTER TABLE public.estado_pk_id_estado_seq OWNER TO db_admin;
...
ALTER TABLE public.finventacanasta OWNER TO db_admin;
...
ALTER TABLE public.finventacanasta_id_canasta_seq OWNER TO db_admin;
...
ALTER TABLE public.formadepago OWNER TO db_admin;
...
ALTER TABLE public.formadepago_pkformapago_seq OWNER TO db_admin;
...
ALTER TABLE public.historicoformapago OWNER TO db_admin;
...
ALTER TABLE public.historicoformapago_pkidformapago_seq OWNER TO db_admin;
...
ALTER TABLE public.historicoventacanasta OWNER TO db_admin;
...
ALTER TABLE public.historicoventacanasta_idventacanasta_seq OWNER TO db_admin;
...
ALTER TABLE public.logos OWNER TO db_admin;
...
ALTER TABLE public.mantenimiento OWNER TO db_admin;
...
ALTER TABLE public.mapeodispensador OWNER TO db_admin;
...
ALTER TABLE public.mapeodispensador_pk_idposicion_seq OWNER TO db_admin;
...
ALTER TABLE public.mensajes OWNER TO db_admin;
...
ALTER TABLE public.moneda OWNER TO db_admin;
...
ALTER TABLE public.moneda_pk_idmoneda_seq OWNER TO db_admin;
...
ALTER TABLE public.precios OWNER TO db_admin;
...
ALTER TABLE public.preset OWNER TO db_admin;
...
ALTER TABLE public.producto OWNER TO db_admin;
...
ALTER TABLE public.producto_pk_idproducto_seq OWNER TO db_admin;
...
ALTER TABLE public.solicitudes OWNER TO db_admin;
...
ALTER TABLE public.tipotransaccion OWNER TO db_admin;
...
ALTER TABLE public.tipotransaccion_pk_idtipotransaccion_seq OWNER TO db_admin;
...
ALTER TABLE public.totales OWNER TO db_admin;
...
ALTER TABLE public.totales_pk_id_posicion_seq OWNER TO db_admin;
...
ALTER TABLE public.venta OWNER TO db_admin;
...
ALTER TABLE public.venta_canasta OWNER TO db_admin;
...
ALTER TABLE public.venta_canasta_id_canasta_seq OWNER TO db_admin;
...
ALTER TABLE public.venta_pk_idventa_seq OWNER TO db_admin;
...
ALTER TABLE public.verificapago OWNER TO db_admin;
...
El  vehiculo  placa  WCW156 , ha sido   autorizado	2	0
El  vehiculo  placa  JGI338 , ha sido   autorizado	1	0
\.
...
1	07630	07090	00000	07630	07090	00000
2	07630	07090	00000	07630	07090	00000
\.
...
1	1 	00010000	39558353	242464.61	007090	2	0	0	0	1	\N	0	0	1
2	F 	00999900	51538809	665344.67	007630	1	0	0	0	1	Felicidades, tiene cupo	0	0	1
\.
...
1	718793.099999999977	242464.630000000005	0	0	69726789	39558509	0	39558509
2	665347.949999999953	335886.880000000005	0	0	51563813	44545836	0	44545836
\.
...
1075542360	1510	1	1	1	Apertura exitosa
\.
...
SELECT pg_catalog.setval('venta_pk_idventa_seq', 29139, true);
...
GRANT ALL ON TABLE consignaciones TO php_admin;
...
GRANT ALL ON TABLE tipotransaccion TO php_admin;
